...
internal class AlbumListAdapter : ListAdapter<AlbumListItem, AlbumItemViewHolder>(AlbumItemDiffer) {

  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AlbumItemViewHolder {
    val binding = GridItemAlbumBinding.inflate(LayoutInflater.from(parent.context), parent, false)
